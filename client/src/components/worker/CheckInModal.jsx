...
const STEPS = ['GPS Location', 'Face Capture', 'Field Photo', 'Confirm'];
...
export default function CheckInModal({ isOpen, onClose, task, onSuccess }) {
  ...
  const handleSubmit = async () => {
    if (!task?._id || !gpsData || !faceImageFile || !fieldImageFile) return;
    setSubmitting(true);
    try {
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {!task && (
              <p className="text-center text-gray-600">No task selected.</p>
            )}
              ...
              <div className="space-y-6 pt-2 text-center">
                {result.status === 'FLAGGED' ? (
                  <>
                    ...
                    <h3 className="text-xl font-bold text-amber-700">Checked In with Flags</h3>
                    ...
                    <p className="text-sm text-gray-500">Team lead has been notified</p>
                  </>
                ) : (
                  <>
                    <motion.div
                    ...
                    <h3 className="text-xl font-bold text-[#005F02]">Checked In Successfully!</h3>
            ...
            {task && !result && (
              <>
                <h2 className="bg-[#F1F8E9] border-b border-[#E0E7DC] px-4 sm:px-[24px] py-[16px] rounded-t-[20px] text-[1rem] font-semibold text-[#212121] -mx-4 sm:-mx-[24px] -mt-4 sm:-mt-[24px] mb-[24px] pr-12">Check In</h2>
